...
import tn.esprit.spring.entities.Departements;
import tn.esprit.spring.entities.Entreprise;
import tn.esprit.spring.entities.Entreprises;
...
public class RestControlEntreprise {
	...
	@ResponseBody
	public int ajouterEntreprise(Entreprises ssiiConsulting) {
	...
	public int ajouterDepartement(Departements dep) {
